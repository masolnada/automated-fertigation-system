...
import { ConfirmArchiveZone, CreateZone, RenameZone } from "./ZoneDialogs";
...
export function Zones({ zones, assignments, onCreate, onRename, onArchive, onUnarchive }: Props) {
  ...
  return <Card className="card-zones">
    ...
    <CreateZone open={creating} onCreate={(name) => { onCreate(name); setCreating(false); }} onCancel={() => setCreating(false)}/>
