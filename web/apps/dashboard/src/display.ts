...
export const entities: Record<string, Entity> = {
  ...
  flow_rate: { kind: "sensor", decimals: 1, label: "Flow rate", unit: "L/min" }, total_water: { kind: "sensor", decimals: 1, label: "Total water", unit: "L" }, default_cycle_minutes: { kind: "number", decimals: 0, label: "Default cycle minutes", unit: "min" }, default_cycle_liters: { kind: "number", decimals: 1, label: "Default cycle liters", unit: "L" }, "default_pre-wet_percent": { kind: "number", decimals: 0, label: "Default pre-wet percent", unit: "%" }, default_flush_minutes: { kind: "number", decimals: 0, label: "Default flush minutes", unit: "min" }, min_flow: { kind: "number", decimals: 1, label: "Min flow", unit: "L/min" }, default_cycle_mode: { kind: "select", decimals: 0, label: "Default cycle mode", unit: "" },
};
