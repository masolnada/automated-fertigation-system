...
import { forgetArchivedZoneColours, forgetZoneColour } from "./zoneColours";
import { ThemeToggle } from "@hort/ui";

export function App({ store }: { store: SnapshotStore }) {
  const snapshot = useStore(store);
  useEffect(() => forgetArchivedZoneColours(snapshot.zones), [snapshot.zones]);
