...
export const variants = {
  ...
  title: "flex items-center gap-[0.7rem] mb-5 pb-[0.9rem] border-b-[2px] border-dashed border-gray text-[0.85rem] font-extrabold uppercase tracking-[0.16em] max-[640px]:flex-wrap [&>span:last-child:not(:first-child)]:ml-auto",
